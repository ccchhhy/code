...
def set_args():
    ...
    parser.add_argument('--image_path', default=r'C:\\Users\\chy\\Desktop\\fusion\\EA-DenseFuse-main\\1\\vis', type=str, help='训练集路径')
    parser.add_argument('--gray', default=True, type=bool, help='是否使用灰度模式')
    parser.add_argument('--batch_size', default=4, type=int, help='批量大小')
