...
gray = True
if gray:
    IR_image_path = 'gam/ir/'
    VIS_image_path = 'gam/vis/'
    result_path = './image/'

    # IR_image_path = 'test_data/Road/1/'
    # VIS_image_path = 'test_data/Road/gam/'
    # result_path = './tttttttttttttt/Road_fusion_result/'

    weight_path = './weight_attention/1124_15-46_Gray_epoch=50.pt'
else:
    # IR_image_path = 'test_data/Lytro/1/'
    # VIS_image_path = 'test_data/Lytro/gam/'
    ...
    weight_path = './weight/0409_13-28_RGB_epoch=gam.pt'
...
for IR_image_name, VIS_image_name in zip(IR_image_list, VIS_image_list):
    with torch.no_grad():
        ...
        # plt.axis("off")
        # plt.imshow(np.transpose(Fusion_image, (1, gam, 0)), cmap='gray')
        # plt.show()
